variable "vpc_endpoints_sg_name" {
    description = "Name of the default vpc endpoint security group"
    default = null
}

# Given that this is just a wrapper module, the rest of the variables defined below are directly from the terraform-aws-vpc module created by the Terraform AWS Modules community. Source: https://github.com/terraform-aws-modules/terraform-aws-vpc/blob/master/variables.tf
variable "create_vpc" {
