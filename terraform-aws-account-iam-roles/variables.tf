...
Unfortunately the terraform `object()` type doesn't support optional parameters and the terraform `map(any)` type requires a consistent type for each value. This resorted in var.roles type to equal `any`.

Since this module is just a simple wrapper on top of the iam-assumable-role module, the var.roles dictionary parameters are equal to the variables defined below.
...
Credit Source: https://github.com/terraform-aws-modules/terraform-aws-iam/blob/master/examples/iam-assumable-role/variables.tf
*/
